...
use Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\Handler\CurlShareHandleState;
use Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\Handler\CurlVersion;
 ...
 * @final
 */
class Client implements ClientInterface, \Automattic\WooCommerce\GoogleListingsAndAds\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
